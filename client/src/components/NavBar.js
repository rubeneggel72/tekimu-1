  ...
  render() {
    ...
    const LoggedInLinks = () => {
      ...
      const sideList = (side, listNotif) => (
        ...
        >
          <h5 style={{ textAlign: "center", color: "#ff75ac" }}>
            Notifications
          </h5>
          <List>
            {listNotif.length < 1 ? (
    ...
    function LoggedOutLinks() {
      return (
        <ul className="right hide-on-med-and-down">
          ...
          <li>
            <NavLink to="/users/login">Ingresa</NavLink>
          </li>
        </ul>
      );
    }
    ...
    const MobileLoggedInLinks = () => {
      ...
      const MobileMenuLogged = menu => (
        ...
        >
          <h5 style={{ textAlign: "center", color: "#ff75ac" }}>Menu</h5>
          <List>
            <ListItem>
              <NavLink to={"/main/search/"} className="mobile-menu-links">
                ...
                <span className="mobile-menu-notif-text">Buscar</span>
              </NavLink>
            </ListItem>
            <ListItem>
              <NavLink
              ...
              >
                ...
                <span className="mobile-menu-notif-text">Mi perfil</span>
              </NavLink>
            </ListItem>
            <ListItem>
              <Button
              ...
              >
                ...
                <span className="mobile-menu-notif-text">Notificaciones</span>
              </Button>
            </ListItem>
          </List>
          <Divider />
          <List>
            <ListItem>
              ...
              >
                ...
                <span className="mobile-menu-notif-text">Mensajes</span>
              </NavLink>
            </ListItem>
          </List>
          <Divider />
          <List>
            <ListItem>
              <NavLink className="mobile-menu-links" onClick={logout} to="#">
                <span className="mobile-menu-notif-text">Salir</span>
              </NavLink>
            </ListItem>
          </List>
        </div>
          ...
          <List>
            <ListItem>
              <NavLink className="mobile-menu-links" to="/users/login">
                ...
                <span className="mobile-menu-notif-text">Ingresar</span>
              </NavLink>
            </ListItem>
            <ListItem>
              <NavLink className="mobile-menu-links" to="/users/register">
                ...
                <span className="mobile-menu-notif-text">Registrate</span>
              </NavLink>
            </ListItem>
          </List>
        </div>
