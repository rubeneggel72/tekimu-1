...
class Register extends Component {
        ...
        <div className="row login-register-page">
          <div className="col a12 m6" id="login-box">
            <div className="login-header">
              Registrate y encontraras lo que necesitas...{" "}
            ...
            <div className="card-panel center">
              ...
              <span className="title-page">Registro</span>
              <div className="card-panel">
                <form onSubmit={this.handleSubmit}>
                  ...
                  <div className="input-field col s6 name-size">
                    ...
                    <label htmlFor="firstname-register">Nombre</label>
                  </div>
                  <div className="input-field col s12">
                    ...
                    <label htmlFor="username-register">Nick</label>
                  </div>
                  <div className="input-field col s12">
                    <i className="material-icons prefix input-icons">
                      mail_outline
                  ...
                  <div className="input-field col s12">
                    ...
                    >
                      <h3 id="pwd1-verify-title">
                        Contraseña debe incluir lo siguiente:
                      </h3>
                      <p
                        id="letter"
                        className={
                  ...
                  <div className="input-field col s12">
                    ...
                    <label htmlFor="rep-pwd-login">Repita la contraseña</label>
                  </div>
                  <div id="error-back" />
                  <input
                    type="submit"
  ...
  validateRepeatPwd = () => {
    if (this.state.pwd1 === this.state.pwd2) {
      ...
      this._isMounted && this.setState({ pwd2Error: "Contraseñas no coinciden" });
    }
  };
  ...
  handleSubmit = async e => {
    ...
    await Axios.post("/users/register", {
      ...
      .catch(err => {
        ...
        ErrorToast.custom.error(message, 3000);
      });
  };
