    ...
    return (
      <div>
        <Modal
          ...
          className="modals"
          header="Edita la informacion de tu perfil "
          fixedFooter
          trigger={false}
        >
          <p className="modal-intro">
            Puedes editar y guardar información que será visible en tu perfil
          </p>
          <span className="profile-fields-labels">Genero</span>
          {this.state.gender !== "" && <SelectGender />}
          <span className="profile-fields-labels">Orientación Sexual</span>
          {this.state.sexOrientation !== "" && <SelectSexOrientation />}
          <span className="profile-fields-labels">Mi detalle</span>
          ...
          <span className="profile-fields-labels">Ciudad</span>
          <SelectLocation />
          <span className="profile-fields-labels">Interesado en</span>
          <InterestTags />
        </Modal>
      </div>
    );
