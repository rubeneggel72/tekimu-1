      ...
      <div>
        {this.state.userId !== null && (
          <Modal
            ...
            className="modals"
            header="Edición de parametros de tu cuenta"
            fixedFooter
            trigger={false}
          >
            <p className="modal-intro">
              Puedes modificar los parámetros de tu cuenta y de tus parametros de busqueda
            </p>
            <span className="profile-fields-labels">Parámetros de búsqueda</span>
            <AgeSlider
