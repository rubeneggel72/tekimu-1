      ...
      <div>
        {this.state.userId === this.props.userConnectedData.id && (
          <Modal
            ...
            className="modals"
            header="Filtro de  perfiles"
            fixedFooter
            trigger={false}
          >
            <p className="modal-intro">
              Puedes editar tu perfil de filtros para mejorar tus búsquedas
            </p>
            <span className="profile-fields-labels">Configuracion de Filtros</span>
            <AgeSlider
            ...
            {this.props.userConnectedData.tags !== undefined && (
              <div>
                <span className="profile-fields-labels">Filtro</span>
                <InterestTagsDumb
