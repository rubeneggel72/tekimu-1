    ...
    return (
      <div>
        <Modal
          ...
          className="modals"
          header="Panel de visitas, likes, usuarios bloqueados"
          fixedFooter
          trigger={false}
        >
          <p className="modal-intro">
            Mira los perfiles que visitaste, tus likes y a quienes bloqueaste
          </p>
          <div>
            <span className="profile-fields-labels">Usuarios visitados</span>
            <div className="user-list-reduced-container">
              <ViewProfilesList users={this.state.profilesVisited} />
            </div>
            <span className="profile-fields-labels">Usuarios que te gustan</span>
            <div className="user-list-reduced-container">
