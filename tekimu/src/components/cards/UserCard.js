        ...
        <div className="card sticky-action">
                ...
                <div
                  ...
                  onClick={
                    this.props.pictures
                      ...
                      : () => {
                          alert(
                            "Tienes que agregar fotos a tu perfil."
                          );
                        }
                  }
                >
              ...
              <div className="user-card-orientation">
                ...
                <span className="profile-text-icon">
                  {this.props.intel.sexual_orientation !== null ? (
                    ...
                    <span className="grey-message">Aún sin preferencia</span>
                  )}
                </span>
              </div>
              <div className="user-card-location">
                <i className="material-icons prefix pink-icon">Lugar</i>{" "}
                <span className="profile-text-icon">
                  {this.props.intel.city !== null ? (
                    this.props.intel.city
                  ) : (
                    <span className="grey-message">Sin localización aún</span>
                  )}
                </span>
              </div>
              <div className="user-card-birthdate">
                ...
                <span className="profile-text-icon">
                  {this.props.intel.birthdate !== null ? (
                    ...
                    <span className="grey-message">Cumpleaños no especificado</span>
                  )}
                </span>
              </div>
          ...
          <div className="card-reveal">
            <span className="card-title grey-text text-darken-4">
              Acerca de mi<i className="material-icons right">close</i>
            </span>
            <p>
              {this.props.intel.bio !== null || this.props.intel.bio === "" ? (
                this.props.intel.bio
              ) : (
                <span className="grey-message">Sin comentarios aún</span>
              )}
            </p>
            <InterestTagsOnly tags={this.state.taggs} />
          </div>
