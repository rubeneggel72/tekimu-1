    ...
    ApiCall.user
      ...
      .then(response => {
        ...
        axios
          ...
          .then(response => {
            InfoToast.custom.info("Deleted", 3000);
      ...
      .catch(error => {
        ErrorToast.custom.error(error.response["data"]["error"], 3000);
    ...
    ApiCall.user
      ...
      .then(response => {
        ...
        axios
          .get(`${apiUrl}/profile/${username}`)
          .then(response => {
            InfoToast.custom.info("Updated", 3000);
            dispatch({ type: "USER_RECEIVED", payload: response.data });
          })
          .catch(error => {
            dispatch({
    ...
    ApiCall.user
      ...
      .then(response => {
        ...
        axios
          .get(`${apiUrl}/profile/${username}`)
          .then(response => {
            InfoToast.custom.info("Profile picture changed", 3000);
            dispatch({ type: "USER_RECEIVED", payload: response.data });
          })
          .catch(error => {
            dispatch({
